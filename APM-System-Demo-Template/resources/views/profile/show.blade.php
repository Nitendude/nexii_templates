...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            @endif
            <a class="btn btn-outline-primary" href="{{ route('change-password.edit') }}">Change Password</a>
        </div>
    </div>
            ...
            @if(auth()->id() === $employee->id)
                <div class="col-12">
                    @if(session('status') === 'photo-updated')
                        <div class="alert alert-success mt-3 mb-0">Profile photo updated.</div>
                    @endif
                    @if($errors->any())
                    ...
                    @endif
                    <form class="mt-3" method="POST" action="{{ route('my-profile.photo') }}" enctype="multipart/form-data">
                        @csrf
    ...
    <ul class="nav nav-tabs mb-3" id="profileTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-pane" type="button" role="tab">My Profile</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="employment-tab" data-bs-toggle="tab" data-bs-target="#employment-pane" type="button" role="tab">Employment Details</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="emergency-tab" data-bs-toggle="tab" data-bs-target="#emergency-pane" type="button" role="tab">Emergency Contact</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="contrib-tab" data-bs-toggle="tab" data-bs-target="#contrib-pane" type="button" role="tab">Contributions</button>
        </li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade" id="employment-pane" role="tabpanel">
            <div class="row g-3">
                <div class="col-lg-6">
                    <div class="eh-card p-3">
        ...
        <div class="tab-pane fade" id="contrib-pane" role="tabpanel">
            <div class="row g-3">
                <div class="col-lg-6">
                    <div class="eh-card p-3">
